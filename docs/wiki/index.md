...
Terma — современный эмулятор терминала, построенный на Electron, React и xterm.js. Вдохновлён Warp и Wave Terminal. Ключевые возможности: сплит-панели, табы, динамические типы панелей (терминал / файловый менеджер / агент), голосовой ввод через Whisper, персистентные сессии.
